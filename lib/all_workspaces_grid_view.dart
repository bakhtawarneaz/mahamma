...
import './navbar.dart';
import './all_workspaces_search.dart';
import './all_workspaces_add_new.dart';
import './all_workspaces_grid_view2.dart';
import './all_workspaces_company_tabs.dart';
import './all_workspaces_sort_by.dart';
import 'package:flutter_svg/flutter_svg.dart';

class AllWorkspacesGridView extends StatelessWidget {
  AllWorkspacesGridView({
    Key? key,
  }) : super(key: key);
  @override
              ...
              child: PageLink(
                links: [
                  PageLinkInfo(
                    ...
                    ease: Curves.easeOut,
                    duration: 0.3,
                    pageBuilder: () => AllWorkspacesSearch(),
                  ),
                ],
                child: Stack(
                  children: <Widget>[
