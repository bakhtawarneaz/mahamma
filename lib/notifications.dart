                  ...
                  child: SizedBox(
                    ...
                    child: Stack(
                      children: <Widget>[
                        ...
                        Pinned.fromPins(
                          Pin(size: 63.0, middle: 0.6824),
                          Pin(size: 16.0, start: 5.0),
                          child: Text(
                            '2 hours ago',
                            style: TextStyle(
                              fontFamily: 'Airbnb Cereal App',
                        ...
                        Pinned.fromPins(
                          ...
                          child: Text(
                            'Project A Ahmed assign a task to you.',
                            style: TextStyle(
                              fontFamily: 'Airbnb Cereal App',
                              fontSize: 14,
