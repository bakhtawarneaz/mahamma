    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
            ...
            child: PageLink(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromPins(
                    Pin(size: 175.0, middle: 0.3315),
                    Pin(size: 19.0, end: 2.0),
                    child: Text(
                      'Member sent an attachment',
                      style: TextStyle(
                        fontFamily: 'Airbnb Cereal App',
                        fontSize: 14,
                        color: const Color(0xff010503),
          ...
          Align(
            alignment: Alignment(0.694, -0.844),
            child: SizedBox(
              width: 24.0,
              height: 24.0,
              child: PageLink(
