...
class WorkspaceTeamGrid extends StatelessWidget {
  WorkspaceTeamGrid({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Align(
            alignment: Alignment(-0.051, -0.348),
            child: SizedBox(
              width: 93.0,
              height: 19.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(-0.051, 0.045),
            child: SizedBox(
              width: 93.0,
              height: 19.0,
              child: Text(
