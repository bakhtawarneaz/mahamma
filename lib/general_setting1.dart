...
class GeneralSetting1 extends StatelessWidget {
  GeneralSetting1({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 95.0, start: 18.0),
            Pin(size: 45.0, middle: 0.4443),
            child: Stack(
              children: <Widget>[
                Container(
                  decoration: BoxDecoration(
                    ...
                    border:
                        Border.all(width: 1.0, color: const Color(0xff747373)),
                  ),
                ),
                Align(
                  alignment: Alignment(0.032, -0.083),
                  child: SizedBox(
                    width: 64.0,
                    height: 21.0,
                    child: Text(
          ...
          Align(
            alignment: Alignment(-0.119, -0.111),
            child: SizedBox(
              width: 97.0,
              height: 45.0,
              child: Stack(
                children: <Widget>[
                  ...
                  Align(
                    alignment: Alignment(-0.03, -0.083),
                    child: SizedBox(
                      width: 64.0,
                      height: 21.0,
                      child: Text(
          ...
          Align(
            alignment: Alignment(-0.197, 0.106),
            child: SizedBox(
              width: 91.0,
              height: 45.0,
              child: Stack(
          ...
          Align(
            alignment: Alignment(0.325, 0.324),
            child: SizedBox(
              width: 135.0,
              height: 45.0,
              child: Stack(
