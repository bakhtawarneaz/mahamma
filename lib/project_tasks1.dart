...
class ProjectTasks1 extends StatelessWidget {
  ProjectTasks1({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Align(
            alignment: Alignment(0.474, -0.409),
            child: SizedBox(
              width: 63.0,
              height: 21.0,
              child: Text(
