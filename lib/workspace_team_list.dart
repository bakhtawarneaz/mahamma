...
class WorkspaceTeamList extends StatelessWidget {
  WorkspaceTeamList({
    Key? key,
  }) : super(key: key);
  @override
...
const String _svg_ffr18i =
    '<svg viewBox="16.0 272.0 358.0 1.0" ><path transform="translate(16.0, 272.0)" d="M 0 0 L 358 0" fill="none" stroke="#f9f9f9" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
