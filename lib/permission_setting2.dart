...
class PermissionSetting2 extends StatelessWidget {
  PermissionSetting2({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Align(
            alignment: Alignment(0.542, -0.426),
            child: SizedBox(
              width: 67.0,
              height: 21.0,
              child: Text(
