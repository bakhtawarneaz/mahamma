...
import './navbar.dart';
import './meeting_profile.dart';
import 'package:adobe_xd/page_link.dart';
import './meeting_files.dart';
import './meeting_actions.dart';
import './meeting_profile_team.dart';
import './meeting_activity.dart';
import 'package:flutter_svg/flutter_svg.dart';

class MeetingActions2 extends StatelessWidget {
  MeetingActions2({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Align(
            alignment: Alignment(0.479, -0.618),
            child: SizedBox(
              width: 60.0,
              height: 21.0,
              child: Text(
                  ...
                  child: PageLink(
                    links: [
                      PageLinkInfo(
                        ...
                        ease: Curves.easeOut,
                        duration: 0.3,
                        pageBuilder: () => MeetingProfileTeam(),
                      ),
                    ],
                    child: Text(
                      'Members',
