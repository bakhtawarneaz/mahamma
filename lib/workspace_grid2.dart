...
import './navbar.dart';
import './workspace_add_new.dart';
import 'package:adobe_xd/page_link.dart';
import './workspace_tabs.dart';
import './workspace_project_sort_by.dart';
import './workspace_project_view.dart';
import 'package:flutter_svg/flutter_svg.dart';

class WorkspaceGrid2 extends StatelessWidget {
  WorkspaceGrid2({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Align(
            alignment: Alignment(-0.007, -0.575),
            child: SizedBox(
              width: 108.0,
              height: 138.0,
              child: Stack(
          ...
          Align(
            alignment: Alignment(-0.007, -0.127),
            child: SizedBox(
              width: 108.0,
              height: 138.0,
              child: Stack(
          ...
          Align(
            alignment: Alignment(-0.007, 0.32),
            child: SizedBox(
              width: 108.0,
              height: 138.0,
              child: Stack(
...
const String _svg_cd21j =
    '<svg viewBox="0.0 0.0 80.0 80.0" ><path  d="M 0 0 L 80 0 L 80 80 L 0 80 L 0 0 Z" fill="none" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_ske7b =
    '<svg viewBox="10.0 26.6 60.0 43.4" ><path transform="translate(7.02, 18.55)" d="M 56.29524230957031 51.42617034912109 L 9.661905288696289 51.42617034912109 C 5.982636451721191 51.42617034912109 3.000000238418579 48.43500518798828 3.000000238418579 44.74521636962891 L 3.000000238418579 14.68094825744629 C 3.000000238418579 10.99116230010986 5.982637405395508 8 9.661907196044922 8 L 56.29524230957031 8 C 59.97451782226562 8 62.95715713500977 10.99116230010986 62.95715713500977 14.68094825744629 L 62.95715713500977 44.74521636962891 C 62.95715713500977 48.43501281738281 59.97451019287109 51.42617034912109 56.29524230957031 51.42617034912109 Z" fill="none" stroke="#b3b4b3" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" /></svg>';
const String _svg_s1ths0 =
    '<svg viewBox="26.6 13.2 26.7 56.8" ><path transform="translate(18.64, 9.19)" d="M 34.72379302978516 60.78807067871094 L 34.72379302978516 10.68095016479492 C 34.72379302978516 6.991163730621338 31.73263549804688 4 28.0428466796875 4 L 14.68094825744629 4 C 10.99116230010986 4 8 6.991163730621338 8 10.68095207214355 L 8 60.78807067871094" fill="none" stroke="#b3b4b3" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" /></svg>';
