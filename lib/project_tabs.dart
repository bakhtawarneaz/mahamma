...
import './project_team_list.dart';
import './project_meetings.dart';
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Align(
            alignment: Alignment(0.474, -0.618),
            child: SizedBox(
              width: 63.0,
              height: 21.0,
              child: Text(
