...
import './navbar.dart';
import './workspace_my_work.dart';
import 'package:adobe_xd/page_link.dart';
import './workspace_project_list.dart';
import './workspace_notes.dart';
import './workspace_team_list.dart';
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Align(
            alignment: Alignment(0.413, -0.618),
            child: SizedBox(
              width: 49.0,
              height: 21.0,
              child: Text(
          ...
          Pinned.fromPins(
            Pin(size: 58.0, start: 36.0),
            Pin(size: 21.0, middle: 0.2454),
            child: Text(
              'Pending',
              style: TextStyle(
                fontFamily: 'Airbnb Cereal App',
          ...
          Pinned.fromPins(
            Pin(size: 38.0, start: 36.0),
            Pin(size: 21.0, middle: 0.5286),
            child: Text(
              'Done',
              style: TextStyle(
                fontFamily: 'Airbnb Cereal App',
                  ...
                  child: PageLink(
                    links: [
                      PageLinkInfo(
                        ...
                        ease: Curves.easeOut,
                        duration: 0.3,
                        pageBuilder: () => WorkspaceProjectList(),
                      ),
                    ],
                    child: Text(
                      'Projects',
...
const String _svg_m9jdb =
    '<svg viewBox="16.0 222.0 374.0 1.0" ><path transform="translate(16.0, 222.0)" d="M 0 0 L 374 0" fill="none" stroke="#ececec" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
