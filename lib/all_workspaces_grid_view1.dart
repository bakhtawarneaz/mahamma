...
class AllWorkspacesGridView1 extends StatelessWidget {
  AllWorkspacesGridView1({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
                    ...
                    child: Stack(
                      children: <Widget>[
                        Container(
                          ...
                          margin: EdgeInsets.fromLTRB(0.0, 0.0, 0.0, 36.0),
                        ),
                        Pinned.fromPins(
                          Pin(size: 48.0, middle: 0.4667),
                          Pin(size: 99.0, start: 1.0),
                          child: Text(
                            'A',
                            style: TextStyle(
                              fontFamily: 'Airbnb Cereal App',
          ...
          Align(
            alignment: Alignment(0.923, -0.854),
            child: SizedBox(
              width: 24.0,
              height: 24.0,
              child: Stack(
...
const String _svg_v75x56 =
    '<svg viewBox="16.0 150.0 358.0 1.0" ><path transform="translate(16.0, 150.0)" d="M 0 0 L 358 0" fill="none" stroke="#c2c2c2" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_eterkn =
    '<svg viewBox="0.0 0.0 24.0 24.0" ><path  d="M 0 0 L 24 0 L 24 24 L 0 24 L 0 0 Z" fill="none" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_enns =
    '<svg viewBox="8.5 6.0 12.0 1.0" ><path  d="M 8.5 6 L 20.5 6" fill="none" stroke="#747373" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /></svg>';
const String _svg_phk0cs =
    '<svg viewBox="3.5 6.0 1.0 1.0" ><path  d="M 3.5 6 L 4.5 6" fill="none" stroke="#747373" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /></svg>';
const String _svg_t79rl =
    '<svg viewBox="3.5 12.0 1.0 1.0" ><path  d="M 3.5 12 L 4.5 12" fill="none" stroke="#747373" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /></svg>';
const String _svg_u5xhyj =
    '<svg viewBox="3.5 18.0 1.0 1.0" ><path  d="M 3.5 18 L 4.5 18" fill="none" stroke="#747373" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /></svg>';
const String _svg_krpux1 =
    '<svg viewBox="8.5 12.0 12.0 1.0" ><path  d="M 8.5 12 L 20.5 12" fill="none" stroke="#747373" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /></svg>';
const String _svg_h07qh9 =
    '<svg viewBox="8.5 18.0 12.0 1.0" ><path  d="M 8.5 18 L 20.5 18" fill="none" stroke="#747373" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /></svg>';
