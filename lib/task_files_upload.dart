...
import './task_files_upload2.dart';
import 'package:flutter_svg/flutter_svg.dart';

class TaskFilesUpload extends StatelessWidget {
  TaskFilesUpload({
    Key? key,
  }) : super(key: key);
  @override
...
const String _svg_kttn1 =
    '<svg viewBox="15.0 3.0 5.0 5.0" ><path  d="M 20 8 L 16 8 C 15.44771480560303 8 15 7.552284717559814 15 7 L 15 3" fill="none" stroke="#b3b4b3" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /></svg>';
const String _svg_kp5hy =
    '<svg viewBox="5.8 11.3 4.5 3.5" ><path  d="M 5.75 11.25 L 6.25 14.75 L 6.578999996185303 14.75 L 8 11.75 L 9.420999526977539 14.75 L 9.75 14.75 L 10.25 11.25" fill="none" stroke="#b3b4b3" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /></svg>';
const String _svg_md8k5v =
    '<svg viewBox="6.0 3.0 14.0 18.0" ><path  d="M 6 8 L 6 5 C 6 3.895430564880371 6.895430564880371 2.999999761581421 8 3 L 15.17199993133545 3 C 15.7019624710083 3 16.21063232421875 3.210679531097412 16.58569717407227 3.585698127746582 L 19.41400146484375 6.414000034332275 C 19.78910064697266 6.788986206054688 19.99988746643066 7.297610759735107 20 7.828000068664551 L 20 19 C 20 20.10457038879395 19.10456848144531 21 18 21 L 8 21 C 6.895430564880371 21 6 20.10456848144531 6 19 L 6 18" fill="none" stroke="#b3b4b3" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /></svg>';
...
const String _svg_exfz52 =
    '<svg viewBox="5.3 5.3 5.3 5.3" ><path transform="translate(-2.67, -2.67)" d="M 8 8 L 13.33333396911621 13.33333396911621" fill="none" stroke="#b3b4b3" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /></svg>';
const String _svg_ll3xi =
    '<svg viewBox="5.3 5.3 5.3 5.3" ><path transform="translate(-2.67, -2.67)" d="M 13.33333396911621 8 L 8 13.33333396911621" fill="none" stroke="#b3b4b3" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /></svg>';
