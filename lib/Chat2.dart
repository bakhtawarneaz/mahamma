    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Align(
            alignment: Alignment(0.705, -0.844),
            child: SizedBox(
              width: 24.0,
              height: 24.0,
              child: Stack(
          ...
          Pinned.fromPins(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Align(
                  alignment: Alignment(-0.383, -0.542),
                  child: SizedBox(
                    width: 120.0,
                    height: 24.0,
                    child: Text(
                ...
                Pinned.fromPins(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(8.0),
                      border: Border.all(
                          width: 1.0, color: const Color(0xfffbfcfb)),
                    ),
                  ),
                ),
              ],
          ...
          Pinned.fromPins(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Align(
                  alignment: Alignment(0.147, 0.556),
                  child: SizedBox(
                    width: 231.0,
                    height: 18.0,
          ...
          Pinned.fromPins(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Align(
                  alignment: Alignment(-0.549, 0.547),
                  child: SizedBox(
                    width: 32.0,
                    height: 19.0,
                    child: Text(
          ...
          Pinned.fromPins(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Align(
                  alignment: Alignment(-0.312, 0.547),
                  child: SizedBox(
                    width: 145.0,
                    height: 19.0,
                    child: Text(
