...
import './project_my_tasks_view.dart';
import 'package:flutter_svg/flutter_svg.dart';

class WorkspaceMyWork1 extends StatelessWidget {
  WorkspaceMyWork1({
    Key? key,
  }) : super(key: key);
  @override
            ...
            child: PageLink(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromPins(
                    Pin(size: 61.0, start: 16.0),
                    Pin(size: 21.0, middle: 0.4408),
                    child: Text(
                      'Progress',
                      style: TextStyle(
                        fontFamily: 'Airbnb Cereal App',
