    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Align(
            alignment: Alignment(-0.051, -0.331),
            child: SizedBox(
              width: 93.0,
              height: 19.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(-0.051, 0.062),
            child: SizedBox(
              width: 93.0,
              height: 19.0,
              child: Text(
          ...
          Pinned.fromPins(
            Pin(size: 109.0, start: 266.0),
            Pin(start: 319.0, end: 416.0),
            child: Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: const AssetImage(''),
