    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(start: 14.0, end: 44.0),
            Pin(size: 72.0, middle: 0.4275),
            child: Stack(
              children: <Widget>[
                Container(
                  decoration: BoxDecoration(
          ...
          Pinned.fromPins(
            Pin(start: 47.0, end: 11.0),
            Pin(size: 72.0, middle: 0.2927),
            child: Stack(
              children: <Widget>[
                Container(
                  decoration: BoxDecoration(
          ...
          Pinned.fromPins(
            Pin(start: 45.0, end: 13.0),
            Pin(size: 72.0, middle: 0.5622),
            child: Stack(
              children: <Widget>[
                Container(
                  decoration: BoxDecoration(
