...
class NotificationSetting1 extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 40.0, start: 18.0),
            Pin(size: 21.0, middle: 0.3451),
            child: Text(
              'From:',
              style: TextStyle(
                fontFamily: 'Airbnb Cereal App',
