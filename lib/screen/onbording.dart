      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            Pin(size: 438.0, middle: 0.3621),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(size: 237.0, start: 0.0),
                  Pin(size: 32.0, end: 61.0),
                  child: Text(
                    'PLAN AND ORGANIZE',
                    style: TextStyle(
                      fontFamily: 'Airbnb Cereal App',
