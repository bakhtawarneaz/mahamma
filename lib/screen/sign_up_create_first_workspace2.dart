...
import './sign_up_create_first_workspace4.dart';
import 'package:flutter_svg/flutter_svg.dart';

class SignUpCreateFirstWorkspace2 extends StatelessWidget {
  SignUpCreateFirstWorkspace2({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Container(),
          Pinned.fromPins(
            Pin(size: 103.0, start: 139.0),
            Pin(size: 21.0, start: 382.0),
            child: PageLink(
              links: [
                PageLinkInfo(
                  ease: Curves.easeInOut,
                  duration: 0.4,
                  pageBuilder: () => SignUpCreateFirstWorkspace4(),
                ),
              ],
              child: Text(
                'Change Avatar',
