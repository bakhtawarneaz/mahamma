    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
              ...
              children: <Widget>[
                Container(
                  decoration: BoxDecoration(
                    ...
                    border:
                        Border.all(width: 1.0, color: const Color(0xff32a15a)),
                  ),
                ),
                Align(
          ...
          Align(
            alignment: Alignment(-0.119, -0.114),
            child: SizedBox(
              width: 97.0,
              height: 45.0,
              child: Stack(
          ...
          Align(
            alignment: Alignment(-0.197, 0.104),
            child: SizedBox(
              width: 91.0,
              height: 45.0,
              child: Stack(
          ...
          Align(
            alignment: Alignment(0.325, 0.322),
            child: SizedBox(
              width: 135.0,
              height: 45.0,
              child: Stack(
