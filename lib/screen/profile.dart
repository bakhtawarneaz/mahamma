    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 131.0, middle: 0.3012),
            Pin(size: 24.0, start: 59.0),
            child: Text(
              'Mohamed Samir',
              style: TextStyle(
                fontFamily: 'Airbnb Cereal App',
          ...
          Align(
            alignment: Alignment(0.431, -0.618),
            child: SizedBox(
              width: 49.0,
              height: 21.0,
              child: Text(
