...
class SignUpCreateUserProfile2 extends StatelessWidget {
  SignUpCreateUserProfile2({
    Key? key,
  }) : super(key: key);
  @override
          ...
          Pinned.fromPins(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Align(
                  alignment: Alignment(-0.066, -0.304),
                  child: SizedBox(
                    width: 76.0,
                    height: 48.0,
                    child: Stack(
                ...
                Pinned.fromPins(
                  Pin(size: 86.0, end: 44.0),
                  Pin(size: 48.0, middle: 0.3478),
                  child: Stack(
                    children: <Widget>[
                      Pinned.fromPins(
                        Pin(start: 0.0, end: 0.0),
