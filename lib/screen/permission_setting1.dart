...
class PermissionSetting1 extends StatelessWidget {
  PermissionSetting1({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Align(
            alignment: Alignment(0.585, -0.618),
            child: SizedBox(
              width: 67.0,
              height: 21.0,
              child: Text(
...
const String _svg_qm75p =
    '<svg viewBox="16.0 251.0 358.0 1.0" ><path transform="translate(16.0, 251.0)" d="M 0 0 L 358 0" fill="none" stroke="#ececec" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
