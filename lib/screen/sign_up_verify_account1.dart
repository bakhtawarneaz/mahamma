...
class SignUpVerifyAccount1 extends StatelessWidget {
  SignUpVerifyAccount1({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Container(),
          Align(
            alignment: Alignment(-0.051, -0.383),
            child: SizedBox(
              width: 118.0,
              height: 118.0,
              child: Stack(
