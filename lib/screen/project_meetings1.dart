...
class ProjectMeetings1 extends StatelessWidget {
  ProjectMeetings1({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Align(
            alignment: Alignment(0.395, -0.434),
            child: SizedBox(
              width: 33.0,
              height: 21.0,
              child: Text(
