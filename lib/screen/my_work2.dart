...
class MyWork2 extends StatelessWidget {
  MyWork2({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Align(
            alignment: Alignment(0.46, -0.402),
            child: SizedBox(
              width: 49.0,
              height: 21.0,
              child: Text(
