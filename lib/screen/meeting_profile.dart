...
class MeetingProfile extends StatelessWidget {
  MeetingProfile({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Align(
            alignment: Alignment(0.004, -0.623),
            child: SizedBox(
              width: 109.0,
              height: 48.0,
              child: Stack(
