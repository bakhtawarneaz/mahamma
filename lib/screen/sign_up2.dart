...
import './sign_up_verify_account.dart';
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Container(),
          Pinned.fromPins(
            Pin(size: 207.0, start: 16.0),
            Pin(size: 104.0, start: 114.0),
            child: Text(
              'Welcome,\nWe Help you to \nmanage work Easly.',
              style: TextStyle(
                fontFamily: 'Airbnb Cereal App',
          ...
          Pinned.fromPins(
            Pin(size: 212.0, start: 86.0),
            Pin(size: 21.0, start: 507.0),
            child: PageLink(
              links: [
                PageLinkInfo(
