...
class MyWorkActivity1 extends StatelessWidget {
  MyWorkActivity1({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Align(
            alignment: Alignment(0.461, -0.575),
            child: SizedBox(
              width: 60.0,
              height: 21.0,
              child: Text(
