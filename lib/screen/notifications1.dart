          ...
          Pinned.fromPins(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Align(
                  alignment: Alignment(-0.56, -0.488),
                  child: SizedBox(
                    width: 117.0,
                    height: 21.0,
                    child: Text(
                ...
                Align(
                  alignment: Alignment(0.187, -0.417),
                  child: SizedBox(
                    width: 63.0,
                    height: 16.0,
                    child: Text(
