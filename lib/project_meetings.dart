...
class ProjectMeetings extends StatelessWidget {
  ProjectMeetings({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Align(
            alignment: Alignment(0.378, -0.618),
            child: SizedBox(
              width: 33.0,
              height: 21.0,
              child: Text(
