...
class ProfileSetting1 extends StatelessWidget {
  ProfileSetting1({
    Key? key,
  }) : super(key: key);
  @override
          ...
          Pinned.fromPins(
            ...
            child: Stack(
              children: <Widget>[
                  ...
                  child: SizedBox(
                    ...
                    child: Stack(
                      children: <Widget>[
                        ...
                        Align(
                          alignment: Alignment(-0.059, -0.083),
                          child: SizedBox(
                            width: 69.0,
                            height: 21.0,
                            child: Text(
                ...
                Pinned.fromPins(
                  Pin(size: 167.0, end: 28.0),
                  Pin(size: 45.0, middle: 0.3838),
                  child: Stack(
                    children: <Widget>[
                      Container(
                        decoration: BoxDecoration(
