    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 235.0, start: 17.0),
            Pin(size: 24.0, middle: 0.5427),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
          ...
          Pinned.fromPins(
            Pin(size: 182.0, middle: 0.5096),
            Pin(size: 182.0, start: 86.0),
            child: Container(
              decoration: BoxDecoration(
          ...
          Pinned.fromPins(
            Pin(size: 136.0, start: 16.0),
            Pin(size: 24.0, middle: 0.3671),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(size: 24.0, start: 0.0),
...
const String _svg_c7kwnk =
    '<svg viewBox="3.0 4.0 18.0 8.0" ><path transform="translate(0.0, -1.0)" d="M 3 6.782000064849854 C 3 7.373000144958496 3.292999982833862 7.926000118255615 3.782000064849854 8.256999969482422 L 9.76300048828125 12.30999946594238 C 11.11816024780273 13.22803688049316 12.89584255218506 13.22803688049316 14.25100135803223 12.30999946594238 L 20.21700096130371 8.265998840332031 C 20.70700073242188 7.935998916625977 21 7.382998943328857 21 6.791998863220215 L 21 6.781998634338379 C 21 5.797999858856201 20.20199966430664 5 19.2180004119873 5 L 4.782000064849854 5 C 3.79800009727478 5 3 5.797999858856201 3 6.782000064849854 Z" fill="none" stroke="#808281" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /></svg>';
const String _svg_ickh7d =
    '<svg viewBox="3.0 6.0 18.0 12.0" ><path transform="translate(0.0, -1.0)" d="M 3 7 L 3 17 C 3 18.10457038879395 3.895430564880371 19 5 19 L 19 19 C 20.10457038879395 19 21 18.10456848144531 21 17 L 21 7" fill="none" stroke="#808281" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /></svg>';
const String _svg_lhnu69 =
    '<svg viewBox="3.6 11.3 6.1 6.1" ><path transform="translate(0.0, -1.0)" d="M 3.585999965667725 18.41399955749512 L 9.72599983215332 12.27400016784668" fill="none" stroke="#808281" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /></svg>';
const String _svg_ysz1t3 =
    '<svg viewBox="14.3 11.3 6.1 6.1" ><path transform="translate(0.0, -1.0)" d="M 14.2810001373291 12.2810001373291 L 20.4109992980957 18.4109992980957" fill="none" stroke="#808281" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /></svg>';
