...
import './workspace_my_work1.dart';
import './project_my_tasks_view.dart';
import './workspace_search.dart';
import 'package:flutter_svg/flutter_svg.dart';

class WorkspaceMyWork extends StatelessWidget {
  WorkspaceMyWork({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Align(
            alignment: Alignment(0.413, -0.628),
            child: SizedBox(
              width: 49.0,
              height: 21.0,
              child: Text(
