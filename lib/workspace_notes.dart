...
class WorkspaceNotes extends StatelessWidget {
  WorkspaceNotes({
    Key? key,
  }) : super(key: key);
  @override
      ...
      body: Stack(
        children: <Widget>[
          Pinned.fromPins(
            ...
            Pin(size: 145.0, middle: 0.6753),
            child: Stack(
              children: <Widget>[
                Container(
                  decoration: BoxDecoration(
                    color: const Color(0xfffffaba),
                    boxShadow: [
                      BoxShadow(
          ...
          Pinned.fromPins(
            Pin(start: 16.0, end: 16.0),
            Pin(size: 145.0, middle: 0.4449),
            child: Stack(
              children: <Widget>[
                Container(
                  decoration: BoxDecoration(
                    color: const Color(0xffc7fe80),
                    boxShadow: [
                      BoxShadow(
                        color: const Color(0x0d000000),
                        offset: Offset(0, 3),
