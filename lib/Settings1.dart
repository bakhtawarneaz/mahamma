    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 109.0, end: 229.0),
            Pin(start: 196.0, end: 627.0),
            child: Text(
              'General Setting',
              style: TextStyle(
                fontFamily: 'Airbnb Cereal App',
          ...
          Pinned.fromPins(
            Pin(size: 112.0, end: 226.0),
            Pin(start: 148.0, end: 675.0),
            child: Text(
              'Account Setting',
              style: TextStyle(
                fontFamily: 'Airbnb Cereal App',
          ...
          Pinned.fromPins(
            Pin(size: 85.0, end: 253.0),
            Pin(start: 341.0, end: 482.0),
            child: Text(
              'Integrations',
              style: TextStyle(
                fontFamily: 'Airbnb Cereal App',
          ...
          Pinned.fromPins(
            Pin(size: 83.0, end: 255.0),
            Pin(start: 293.0, end: 530.0),
            child: Text(
              'Permissions',
              style: TextStyle(
                fontFamily: 'Airbnb Cereal App',
          ...
          Pinned.fromPins(
            Pin(size: 24.0, middle: 0.0437),
            Pin(size: 24.0, end: 528.0),
            child:
                ...
                Align(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                          width: 1.5, color: const Color(0xff747373)),
                    ),
                  ),
                ),
                Container(
                  decoration: BoxDecoration(
                    ...
                    border:
                        Border.all(width: 1.5, color: const Color(0xff747373)),
                  ),
          ...
          Pinned.fromPins(
            Pin(size: 90.0, end: 248.0),
            Pin(start: 245.0, end: 578.0),
            child: Text(
              'Notifications',
              style: TextStyle(
                fontFamily: 'Airbnb Cereal App',
          ...
          Align(
            alignment: Alignment(-0.913, -0.405),
            child: SizedBox(
              width: 24.0,
              height: 24.0,
              child: Stack(
