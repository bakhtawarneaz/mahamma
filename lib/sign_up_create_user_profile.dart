...
import './sign_up_create_user_profile1.dart';
import 'package:adobe_xd/page_link.dart';
import 'package:flutter_svg/flutter_svg.dart';

class SignUpCreateUserProfile extends StatelessWidget {
  SignUpCreateUserProfile({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Padding(
                  padding: EdgeInsets.fromLTRB(32.0, 32.0, 32.6, 32.6),
                  child:
          ...
          Pinned.fromPins(
            Pin(size: 98.0, start: 144.0),
            Pin(size: 21.0, start: 374.0),
            child: Text(
              'Upload photo',
              style: TextStyle(
                fontFamily: 'Airbnb Cereal App',
...
const String _svg_ngj7v =
    '<svg viewBox="10.9 8.2 33.6 39.0" ><path transform="translate(6.89, 5.17)" d="M 20.78601455688477 22.50926780700684 C 15.59623908996582 22.49615859985352 11.39224338531494 18.15302658081055 11.37955284118652 12.79148769378662 C 11.37955188751221 7.441609382629395 15.60962867736816 3 20.78601455688477 3 C 25.97579765319824 3.01310658454895 30.17979431152344 7.356238842010498 30.19248390197754 12.71778392791748 C 30.19247817993164 18.06765747070312 25.96240043640137 22.50926780700684 20.78601455688477 22.50926780700684 Z M 35.47377395629883 42.01853561401367 L 6.098251342773438 42.01853561401367 C 4.944212913513184 42.01853561401367 4 41.04307174682617 4 39.8508415222168 L 4 37.68314361572266 C 4 32.91420745849609 7.776853561401367 29.01235580444336 12.3930082321167 29.01235580444336 L 29.17902183532715 29.01235580444336 C 33.7951774597168 29.01235580444336 37.57202529907227 32.91420745849609 37.57202529907227 37.68314361572266 L 37.57202529907227 39.8508415222168 C 37.57202529907227 41.04307174682617 36.62781524658203 42.01853561401367 35.47377395629883 42.01853561401367 Z" fill="none" stroke="#b3b4b3" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /></svg>';
const String _svg_k4u7b3 =
    '<svg viewBox="0.0 0.0 55.4 55.4" ><path  d="M 0 0 L 55.35804748535156 0 L 55.35804748535156 55.35804748535156 L 0 55.35804748535156 L 0 0 Z" fill="none" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
